...
const GaleriaPreWedding: React.FC = () => {
    ...
    useEffect(() => {
        const loadImages = async () => {
            const imageSources: ImageProps[] = [
                { src: '/assets/prewedding/1.jpg', alt: 'Imagem 1', isVertical: true },
                { src: '/assets/prewedding/2.jpg', alt: 'Imagem 2', isVertical: false },
                { src: '/assets/prewedding/3.jpg', alt: 'Imagem 3', isVertical: true },
                { src: '/assets/prewedding/4.jpg', alt: 'Imagem 4', isVertical: true },
                { src: '/assets/prewedding/5.jpg', alt: 'Imagem 5', isVertical: true },
                { src: '/assets/prewedding/6.jpg', alt: 'Imagem 6', isVertical: false },
                { src: '/assets/prewedding/8.jpg', alt: 'Imagem 8', isVertical: true },
                { src: '/assets/prewedding/9.jpg', alt: 'Imagem 9', isVertical: true },
                { src: '/assets/prewedding/10.jpg', alt: 'Imagem 10', isVertical: true },
                { src: '/assets/prewedding/11.jpg', alt: 'Imagem 11', isVertical: false },
                { src: '/assets/prewedding/12.jpg', alt: 'Imagem 12', isVertical: true },
                { src: '/assets/prewedding/13.jpg', alt: 'Imagem 13', isVertical: true },
                { src: '/assets/prewedding/14.jpg', alt: 'Imagem 14', isVertical: true },
                { src: '/assets/prewedding/15.jpg', alt: 'Imagem 15', isVertical: false },
                { src: '/assets/prewedding/16.jpg', alt: 'Imagem 16', isVertical: true },
                { src: '/assets/prewedding/17.jpg', alt: 'Imagem 17', isVertical: true },
            ];
...
export default GaleriaPreWedding;
