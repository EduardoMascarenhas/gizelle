...
const GaleriaCasamentos: React.FC = () => {
    ...
    useEffect(() => {
        const loadImages = async () => {
            const imageSources: ImageProps[] = [
                { src: '/assets/casamentos/1.jpg', alt: 'Imagem 1', isVertical: true },
                { src: '/assets/casamentos/2.png', alt: 'Imagem 2', isVertical: false },
                { src: '/assets/casamentos/3.jpg', alt: 'Imagem 3', isVertical: false },
                { src: '/assets/casamentos/4.png', alt: 'Imagem 4', isVertical: false },
                { src: '/assets/casamentos/5.jpg', alt: 'Imagem 5', isVertical: false },
                { src: '/assets/casamentos/6.jpg', alt: 'Imagem 6', isVertical: false },
                { src: '/assets/casamentos/7.jpg', alt: 'Imagem 7', isVertical: true },
                { src: '/assets/casamentos/8.jpg', alt: 'Imagem 8', isVertical: false },
                { src: '/assets/casamentos/9.jpg', alt: 'Imagem 9', isVertical: true },
                { src: '/assets/casamentos/10.jpg', alt: 'Imagem 10', isVertical: false },
                { src: '/assets/casamentos/11.jpg', alt: 'Imagem 11', isVertical: true },
                { src: '/assets/casamentos/12.jpg', alt: 'Imagem 12', isVertical: true },
                { src: '/assets/casamentos/13.jpg', alt: 'Imagem 13', isVertical: true },
                { src: '/assets/casamentos/14.jpg', alt: 'Imagem 14', isVertical: true },
                { src: '/assets/casamentos/15.jpg', alt: 'Imagem 15', isVertical: true },
                { src: '/assets/casamentos/16.jpg', alt: 'Imagem 16', isVertical: true },
                { src: '/assets/casamentos/17.jpg', alt: 'Imagem 17', isVertical: false },
                { src: '/assets/casamentos/18.jpg', alt: 'Imagem 18', isVertical: true },
                { src: '/assets/casamentos/19.jpg', alt: 'Imagem 19', isVertical: true },
                { src: '/assets/casamentos/20.jpg', alt: 'Imagem 20', isVertical: true },
            ];
...
export default GaleriaCasamentos;
