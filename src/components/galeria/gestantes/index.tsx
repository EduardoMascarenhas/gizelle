...
const GaleriaGestantes: React.FC = () => {
    ...
    useEffect(() => {
        const loadImages = async () => {
            const imageSources: ImageProps[] = [
                { src: '/assets/gestantes/1.png', alt: 'Imagem 1', isVertical: false },
                { src: '/assets/gestantes/2.jpg', alt: 'Imagem 2', isVertical: true },
                { src: '/assets/gestantes/3.jpg', alt: 'Imagem 3', isVertical: true },
                { src: '/assets/gestantes/4.jpg', alt: 'Imagem 4', isVertical: true },
                { src: '/assets/gestantes/5.jpg', alt: 'Imagem 5', isVertical: true },
                { src: '/assets/gestantes/6.jpg', alt: 'Imagem 6', isVertical: true },
                { src: '/assets/gestantes/7.jpg', alt: 'Imagem 7', isVertical: true },
                { src: '/assets/gestantes/8.jpg', alt: 'Imagem 8', isVertical: true },
                { src: '/assets/gestantes/9.jpg', alt: 'Imagem 9', isVertical: true },
                { src: '/assets/gestantes/10.jpg', alt: 'Imagem 10', isVertical: true },
                { src: '/assets/gestantes/11.jpg', alt: 'Imagem 11', isVertical: true },
                { src: '/assets/gestantes/12.jpg', alt: 'Imagem 12', isVertical: true },
                { src: '/assets/gestantes/13.jpg', alt: 'Imagem 13', isVertical: true },
                { src: '/assets/gestantes/14.jpg', alt: 'Imagem 14', isVertical: true },
            ];
...
export default GaleriaGestantes;
